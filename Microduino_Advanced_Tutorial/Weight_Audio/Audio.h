...
void audio_pause()
{
  Audio_serial.write(sn_pause,4);
  delay(50);
}

void audio_play()
{
  Audio_serial.write(sn_play,4);
  delay(50);
}
...
void audio_device(byte _audio_device)
{
  ...
  Audio_serial.write(sn_device,5);
  delay(1500);
}
...
void audio_choose(byte _audio_choose)
{
  ...
  Audio_serial.write(sn_choose,6);
  delay(100);
}

void audio_reset()
{
  Audio_serial.write(sn_reset,4);
  delay(500);
}

void audio_up()
{
  Audio_serial.write(sn_up,4);
  delay(500);
}

void audio_down()
{
  Audio_serial.write(sn_down,4);
  delay(500);
}

void audio_vol_up()
{
  Audio_serial.write(sn_vol_up,4);
  delay(500);
}

void audio_vol_down()
{
  Audio_serial.write(sn_vol_down,4);
  delay(500);
}
