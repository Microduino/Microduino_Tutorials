/*
  Microgame.h - Arduino Microgame board library
...
/*
 * The following constants are used internally by the Microgame
 * library code.
 */
...
const byte CH_JOYSTICK1_X  = 13;
const byte CH_JOYSTICK1_Y  = 12;
