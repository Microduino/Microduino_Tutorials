...
inline static void initSS()    { pinMode(wiz_cs_pin, OUTPUT); 
                                 digitalWrite(wiz_cs_pin, HIGH); };
inline static void setSS()     { digitalWrite(wiz_cs_pin, LOW); };
inline static void resetSS()   { digitalWrite(wiz_cs_pin, HIGH); };
